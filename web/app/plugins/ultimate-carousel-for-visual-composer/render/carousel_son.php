...
class WPBakeryShortCode_vc_carousel_son extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		<div class="carousel-caption" style="background: none;">
		  <div>
			<?php if ($image_url != '') { ?>
			  	<img src="<?php echo $image_url; ?>" class="ultimate-slide-img" style="max-width: 100%; width: <?php echo $img_width; ?>; height: <?php echo $img_height; ?>; border-radius: <?php echo $img_radius; ?>; margin-bottom: 15px;">
			<?php } ?>
